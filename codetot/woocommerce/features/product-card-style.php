 ...
 * @subpackage Codetot_WooCommerce_Product_Card_Style
		...
		codetot_customizer_register_control(
			array(
				...
				'control_args'        => array(
					'type'    => 'select',
					'choices' => apply_filters(
						'product_card_image_type_options',
						array(
		...
		codetot_customizer_register_control(
			array(
				...
				'control_args'        => array(
					'type'    => 'select',
					'choices' => apply_filters(
						'product_card_discount_badge_style_options',
						array(
		...
		codetot_customizer_register_control(
			array(
				...
				'control_args'        => array(
					'type'    => 'select',
					'choices' => apply_filters(
						'product_card_discount_badge_position_options',
						array(
