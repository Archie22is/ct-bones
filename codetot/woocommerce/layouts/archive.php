...
class Codetot_Woocommerce_Layout_Archive
{
	...
	public function build_wrapper()
	{
		...
		if (is_product_category() ) {
			add_action('codetot_product_archive_after_page_block_main', 'ct_bones_top_product_category_content', 20);
			add_action('woocommerce_after_shop_loop', 'ct_bones_bottom_product_category_content', 10);
		}
	}
	...
	{
		if (is_product_category()) {
			ct_bones_display_product_category_content('top_content', 'message-block--archive-top-content');
		}
	}
...
function ct_bones_display_product_category_content($field_name, $class)
{
...
function ct_bones_top_product_category_content() {
	ct_bones_display_product_category_content('top_content', 'message-block--archive-top-content');
}
