...
class Codetot_Customizer_Settings {
	...
	public function register_typography_settings( $wp_customize ) {
		...
		$font_sizes = apply_filters(
			'codetot_theme_font_size_scale_options',
			array(
		...
		codetot_customizer_register_control(
			array(
				...
				'control_args'        => array(
					'type'    => 'select',
					'choices' => apply_filters(
						'codetot_theme_post_card_style_options',
						array(
	...
	public function register_header_settings( $wp_customize ) {
		...
		$header_layout_options = apply_filters(
			'codetot_theme_header_layout_options',
			array(
		...
		$sticky_header_options = apply_filters(
			'codetot_theme_header_sticky_options',
			array(
		...
		$hide_elements = apply_filters(
			'codetot_theme_header_hide_elements_options',
			array(
		...
		codetot_customizer_register_control(
			array(
				...
				'control_args'        => array(
					'type'    => 'select',
					'choices' => apply_filters(
						'codetot_theme_topbar_column_options',
						array(
