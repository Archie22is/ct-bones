...
function codetot_get_social_links() {
	...
	$keys           = apply_filters( 'codetot_social_link_types', array( 'facebook', 'youtube', 'zalo', 'messenger', 'instagram', ' pinterest', 'linkedin', 'twitter', 'google_business_profile', 'tiktok' ) );
...
function codetot_get_contact_info() {
	$items          = array();
	$setting_prefix = 'codetot_company_';
	$keys           = array( 'hotline', 'address', 'email' );
